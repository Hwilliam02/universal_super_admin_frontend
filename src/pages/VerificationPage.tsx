                      ...
                      <div className="flex gap-3 justify-center" onPaste={handlePaste}>
                        {[0, 1, 2, 3, 4, 5].map((index) => (
                          <Input
                            ...
                            className="w-12 h-12 text-center text-2xl font-mono border-gray-200 focus:border-primary/20 focus:ring-2 focus:ring-green-200 transition-all rounded-lg"
                            placeholder="0"
                          />
                        ))}
                      </div>
